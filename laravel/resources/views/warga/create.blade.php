@extends('layouts.app')
@section('title','Registrasi Warga Baru - Sistem Posyandu')
@section('page_title', 'Registrasi Identitas & Sasaran Posyandu')
@section('content')
<div class="row">
        ...
        <div class="card">
            <div class="card-header bg-primary text-white border-0">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        <h5 class="mb-0">Form Registrasi Warga Baru</h5>
                        <small class="text-white-50">Data identitas wajib diisi untuk terhubung ke database nasional & pelaporan Puskesmas</small>
                    </div>
                </div>
            </div>
            <form method="post" action="{{ url('/warga/tambah') }}">
                ...
                <div class="card-body">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <select name="kategori" required class="form-select" id="kategoriSelect">
                                        ...
                                        <option value="Ibu Hamil" @selected(old('kategori')=='Ibu Hamil')>Ibu Hamil & Nifas</option>
                                        <option value="Lansia" @selected(old('kategori')=='Lansia')>Lansia & PTM</option>
                                    </select>
                                </div>
                                <div class="col-md-6">
                    ...
                    <div class="card mb-4 border">
                        <div class="card-header bg-light">
                            <h6 class="mb-0 text-primary"><i class="bi bi-hospital-fill me-2"></i>Data Puskesmas & Pustu Domisili</h6>
                        </div>
                        <div class="card-body">
                            <div class="row g-3">
                                <div class="col-md-6">
                                    ...
                                    <select name="puskesmas" required class="form-select">
                                        ...
                                        <option @selected(old('puskesmas')=='Puskesmas Kecamatan C')>Puskesmas Kecamatan C</option>
                                        <option @selected(old('puskesmas')=='Puskesmas Pembantu 1')>Puskesmas Pembantu 1</option>
                                        <option @selected(old('puskesmas')=='Puskesmas Pembantu 2')>Puskesmas Pembantu 2</option>
                                    </select>
                    ...
                    <div class="alert alert-info border-0 mt-4">
                        <div class="d-flex">
                            <i class="bi bi-shield-check me-3" style="font-size: 28px;"></i>
                            <div>
                                <strong>Data Anda aman dan terintegrasi.</strong><br>
                                <small>Satu kali input langsung terakumulasi ke sistem pelaporan Puskesmas. Siap terhubung ke platform SATUSEHAT & ASIK Kemenkes RI.</small>
                            </div>
                        </div>
                    </div>
                </div>
